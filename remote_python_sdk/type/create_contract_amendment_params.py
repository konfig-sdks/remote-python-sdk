...
class RequiredCreateContractAmendmentParams(TypedDict):
...
class OptionalCreateContractAmendmentParams(TypedDict, total=False):
    pass

class CreateContractAmendmentParams(RequiredCreateContractAmendmentParams, OptionalCreateContractAmendmentParams):
    pass
