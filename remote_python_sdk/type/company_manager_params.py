...
class RequiredCompanyManagerParams(TypedDict):
...
class OptionalCompanyManagerParams(TypedDict, total=False):
    # The Company ID. Required if the access token can access multiple companies. Optional otherwise.
    company_id: str

class CompanyManagerParams(RequiredCompanyManagerParams, OptionalCompanyManagerParams):
    pass
