...
class RequiredParameterError(TypedDict):
...
class OptionalParameterError(TypedDict, total=False):
    pass

class ParameterError(RequiredParameterError, OptionalParameterError):
    pass
