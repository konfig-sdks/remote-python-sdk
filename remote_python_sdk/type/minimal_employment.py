...
class RequiredMinimalEmployment(TypedDict):
    country: Country
...
class OptionalMinimalEmployment(TypedDict, total=False):
...
class MinimalEmployment(RequiredMinimalEmployment, OptionalMinimalEmployment):
    pass
