...
class RequiredCostCalculatorEstimateParams(TypedDict):
    # Currency Slug
    employer_currency_slug: str

    employments: typing.List[CostCalculatorEmploymentParam]

class OptionalCostCalculatorEstimateParams(TypedDict, total=False):
    include_benefits: bool

    include_cost_breakdowns: bool

class CostCalculatorEstimateParams(RequiredCostCalculatorEstimateParams, OptionalCostCalculatorEstimateParams):
    pass
