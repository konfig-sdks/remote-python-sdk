...
class ListTimeoffResponseData(
        ...
        class properties:
            ...
            class timeoffs(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Timeoff']:
                        return Timeoff
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Timeoff'], typing.List['Timeoff']],
                ...
                def __getitem__(self, i: int) -> 'Timeoff':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["timeoffs"]) -> MetaOapg.properties.timeoffs: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "timeoffs", "total_count", "total_pages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timeoffs"]) -> typing.Union[MetaOapg.properties.timeoffs, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "timeoffs", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        timeoffs: typing.Union[MetaOapg.properties.timeoffs, list, tuple, schemas.Unset] = schemas.unset,
