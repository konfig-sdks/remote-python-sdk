...
class ListEmploymentCustomFieldsResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class custom_fields(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmploymentCustomField']:
                        return EmploymentCustomField
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['EmploymentCustomField'], typing.List['EmploymentCustomField']],
                ...
                def __getitem__(self, i: int) -> 'EmploymentCustomField':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "custom_fields", "total_count", "total_pages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "custom_fields", "total_count", "total_pages", ], str]):
