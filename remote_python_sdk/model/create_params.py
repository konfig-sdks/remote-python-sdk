...
class CreateParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["basic_information", "company_id", "country_code", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["basic_information", "company_id", "country_code", "type", ], str]):
