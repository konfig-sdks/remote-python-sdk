...
class ListPayslipsResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class payslips(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Payslip']:
                        return Payslip
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Payslip'], typing.List['Payslip']],
                ...
                def __getitem__(self, i: int) -> 'Payslip':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payslips"]) -> MetaOapg.properties.payslips: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "payslips", "total_count", "total_pages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payslips"]) -> typing.Union[MetaOapg.properties.payslips, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "payslips", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payslips: typing.Union[MetaOapg.properties.payslips, list, tuple, schemas.Unset] = schemas.unset,
