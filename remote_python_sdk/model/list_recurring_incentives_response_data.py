...
class ListRecurringIncentivesResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class recurring_incentives(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RecurringIncentive']:
                        return RecurringIncentive
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RecurringIncentive'], typing.List['RecurringIncentive']],
                ...
                def __getitem__(self, i: int) -> 'RecurringIncentive':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recurring_incentives"]) -> MetaOapg.properties.recurring_incentives: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "recurring_incentives", "total_count", "total_pages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recurring_incentives"]) -> typing.Union[MetaOapg.properties.recurring_incentives, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "recurring_incentives", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        recurring_incentives: typing.Union[MetaOapg.properties.recurring_incentives, list, tuple, schemas.Unset] = schemas.unset,
