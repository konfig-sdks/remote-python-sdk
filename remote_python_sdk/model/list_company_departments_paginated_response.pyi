...
class ListCompanyDepartmentsPaginatedResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ListCompanyDepartmentsPaginatedResponseData']:
                return ListCompanyDepartmentsPaginatedResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ListCompanyDepartmentsPaginatedResponseData': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "data", "total_count", "total_pages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ListCompanyDepartmentsPaginatedResponseData': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "data", "total_count", "total_pages", ], str]):
