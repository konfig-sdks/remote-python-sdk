...
class DeleteRecurringIncentiveResponse(
    schemas.DictSchema
):
    """
...
have a `pending` status.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['DeleteRecurringIncentiveResponseData']:
                return DeleteRecurringIncentiveResponseData
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'DeleteRecurringIncentiveResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'DeleteRecurringIncentiveResponseData': ...
