...
class ListContractAmendmentResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class contract_amendments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MinimalContractAmendment']:
                        return MinimalContractAmendment
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MinimalContractAmendment'], typing.List['MinimalContractAmendment']],
                ...
                def __getitem__(self, i: int) -> 'MinimalContractAmendment':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contract_amendments"]) -> MetaOapg.properties.contract_amendments: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contract_amendments", "current_page", "total_count", "total_pages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contract_amendments"]) -> typing.Union[MetaOapg.properties.contract_amendments, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contract_amendments", "current_page", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        contract_amendments: typing.Union[MetaOapg.properties.contract_amendments, list, tuple, schemas.Unset] = schemas.unset,
