...
class ListExpenseResponseData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "expenses", "total_count", "total_pages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "expenses", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        expenses: typing.Union[MetaOapg.properties.expenses, list, tuple, schemas.Unset] = schemas.unset,
