...
class CompanyManager(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["company_id", "role", "user_email", "user_id", "user_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["company_id", "role", "user_email", "user_id", "user_name", ], str]):
