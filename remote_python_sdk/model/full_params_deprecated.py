...
Please, use the "FullParams" instead.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address_details", "administrative_details", "bank_account_details", "billing_address_details", "company_id", "contract_details", "country", "emergency_contact_details", "full_name", "job_title", "manager_id", "personal_details", "personal_email", "pricing_plan_details", "provisional_start_date", "seniority_date", ], str]):
