...
class CompanyNotEligibleForCreationErrorResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class code(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'resource_not_eligible',
                    }]
            ...
            class message(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'The company already have employees in integration supported countries.',
                    }]
