...
class ListOffboardingResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class offboardings(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Offboarding']:
                        return Offboarding
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Offboarding'], typing.List['Offboarding']],
                ...
                def __getitem__(self, i: int) -> 'Offboarding':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["offboardings"]) -> MetaOapg.properties.offboardings: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "offboardings", "total_count", "total_pages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["offboardings"]) -> typing.Union[MetaOapg.properties.offboardings, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "offboardings", "total_count", "total_pages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        offboardings: typing.Union[MetaOapg.properties.offboardings, list, tuple, schemas.Unset] = schemas.unset,
