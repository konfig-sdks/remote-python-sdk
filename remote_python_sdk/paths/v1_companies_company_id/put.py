...
class BaseApi(api_client.Api):
    ...
    def _update_company_mapped_args(
        self,
        company_id: str,
    ...
    async def _aupdate_company_oapg(
        self,
...
class UpdateCompanyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_company(
        self,
        company_id: str,
        address_details: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        bank_account_details: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._update_company_mapped_args(
        ...
        return await self._aupdate_company_oapg(
            body=args.body,
    ...
    def update_company(
        ...
        return self._update_company_oapg(
            body=args.body,
            path_params=args.path,
        )
...
class UpdateCompany(BaseApi):
    ...
    async def aupdate_company(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_company(
            company_id=company_id,
            address_details=address_details,
            bank_account_details=bank_account_details,
            country_code=country_code,
    ...
    def update_company(
        ...
        raw_response = self.raw.update_company(
            company_id=company_id,
            address_details=address_details,
            bank_account_details=bank_account_details,
            country_code=country_code,
