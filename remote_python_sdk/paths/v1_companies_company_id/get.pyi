...
class ShowCompanyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_company(
        self,
        company_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_company_mapped_args(
            company_id=company_id,
        )
        return await self._ashow_company_oapg(
    ...
    def show_company(
        ...
        return self._show_company_oapg(
            path_params=args.path,
        )

class ShowCompany(BaseApi):
    ...
    async def ashow_company(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashow_company(
            company_id=company_id,
            **kwargs,
        )
        if validate:
    ...
    def show_company(
        ...
        raw_response = self.raw.show_company(
            company_id=company_id,
        )
        if validate:
            return CompanyResponsePydantic(**raw_response.body)
