...
class BaseApi(api_client.Api):
    ...
    def _show_single_request_mapped_args(
        self,
        id: str,
    ...
    async def _ashow_single_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/contract-amendments/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowSingleRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_single_request(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_single_request_mapped_args(
            id=id,
        )
        return await self._ashow_single_request_oapg(
    ...
    def show_single_request(
        ...
        return self._show_single_request_oapg(
            path_params=args.path,
        )

class ShowSingleRequest(BaseApi):
    ...
    async def ashow_single_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashow_single_request(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def show_single_request(
        ...
        raw_response = self.raw.show_single_request(
            id=id,
        )
        if validate:
            return ContractAmendmentResponsePydantic(**raw_response.body)
