...
from remote_python_sdk.model.list_timeoff_types_response import ListTimeoffTypesResponse as ListTimeoffTypesResponseSchema
...
from remote_python_sdk.type.list_timeoff_types_response import ListTimeoffTypesResponse
...
from remote_python_sdk.pydantic.list_timeoff_types_response import ListTimeoffTypesResponse as ListTimeoffTypesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListTimeoffTypesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListTimeoffTypesResponse
    ...
    async def _alist_types_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/timeoff/types',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListTypes(BaseApi):
    ...
    async def alist_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListTimeoffTypesResponsePydantic:
        raw_response = await self.raw.alist_types(
            **kwargs,
        )
        if validate:
            return ListTimeoffTypesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListTimeoffTypesResponsePydantic, raw_response.body)
