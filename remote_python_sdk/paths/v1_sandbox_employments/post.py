...
from remote_python_sdk.model.employment_creation_response import EmploymentCreationResponse as EmploymentCreationResponseSchema
...
from remote_python_sdk.model.employment_basic_params import EmploymentBasicParams as EmploymentBasicParamsSchema
...
from remote_python_sdk.type.employment_basic_params import EmploymentBasicParams
from remote_python_sdk.type.employment_creation_response import EmploymentCreationResponse
...
from remote_python_sdk.pydantic.employment_creation_response import EmploymentCreationResponse as EmploymentCreationResponsePydantic
from remote_python_sdk.pydantic.not_found_response import NotFoundResponse as NotFoundResponsePydantic
from remote_python_sdk.pydantic.employment_basic_params import EmploymentBasicParams as EmploymentBasicParamsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmploymentBasicParamsSchema


request_body_employment_basic_params = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EmploymentCreationResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: EmploymentCreationResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_employment_without_validations_mapped_args(
        self,
        country_code: str,
        full_name: str,
        job_title: str,
    ...
    async def _acreate_employment_without_validations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/sandbox/employments',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_employment_basic_params.serialize(body, content_type)
    ...
    def _create_employment_without_validations_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateEmploymentWithoutValidationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_employment_without_validations(
        self,
        country_code: str,
        full_name: str,
        job_title: str,
        ...
        **kwargs,
        ...
        args = self._create_employment_without_validations_mapped_args(
        ...
        return await self._acreate_employment_without_validations_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_employment_without_validations(
        self,
        country_code: str,
        full_name: str,
        job_title: str,
        ...
        return self._create_employment_without_validations_oapg(
            body=args.body,
        )

class CreateEmploymentWithoutValidations(BaseApi):
    ...
    async def acreate_employment_without_validations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmploymentCreationResponsePydantic:
        raw_response = await self.raw.acreate_employment_without_validations(
            country_code=country_code,
            full_name=full_name,
            job_title=job_title,
            personal_email=personal_email,
        ...
        if validate:
            return EmploymentCreationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmploymentCreationResponsePydantic, raw_response.body)
    ...
    def create_employment_without_validations(
        ...
        raw_response = self.raw.create_employment_without_validations(
            country_code=country_code,
            full_name=full_name,
            job_title=job_title,
            personal_email=personal_email,
