...
UNKNOWN_PARAMETER_NAME_parameter = api_client.HeaderParameter(
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    headers=[
        UNKNOWN_PARAMETER_NAME_parameter,
        UNKNOWN_PARAMETER_NAME_parameter,
    ]
)
...
class BaseApi(api_client.Api):
    ...
    def _download_file_mapped_args(
        self,
        id: str,
    ...
    async def _adownload_file_oapg(
        self,
...
class DownloadFileRaw(BaseApi):
    ...
    async def adownload_file(
        ...
        **kwargs,
        ...
        args = self._download_file_mapped_args(
            id=id,
        )
        return await self._adownload_file_oapg(
    ...
    def download_file(
        ...
        return self._download_file_oapg(
            path_params=args.path,
        )

class DownloadFile(BaseApi):
    ...
    async def adownload_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_file(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def download_file(
        ...
        raw_response = self.raw.download_file(
            id=id,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
