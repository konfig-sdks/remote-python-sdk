...
class BaseApi(api_client.Api):
    ...
    def _employment_update_mapped_args(
        self,
        employment_id: str,
    ...
    async def _aemployment_update_oapg(
        self,
...
class EmploymentUpdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemployment_update(
        self,
        employment_id: str,
        status: typing.Optional[EmploymentStatus] = None,
        **kwargs,
        ...
        args = self._employment_update_mapped_args(
            employment_id=employment_id,
            status=status,
        )
        return await self._aemployment_update_oapg(
            body=args.body,
    ...
    def employment_update(
        ...
        return self._employment_update_oapg(
            body=args.body,
            path_params=args.path,
        )

class EmploymentUpdate(BaseApi):
    ...
    async def aemployment_update(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemployment_update(
            employment_id=employment_id,
            status=status,
            **kwargs,
        )
    ...
    def employment_update(
        ...
        raw_response = self.raw.employment_update(
            employment_id=employment_id,
            status=status,
        )
        if validate:
