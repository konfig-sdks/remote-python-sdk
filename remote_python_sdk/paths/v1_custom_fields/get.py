...
from remote_python_sdk.model.list_employment_custom_fields_response import ListEmploymentCustomFieldsResponse as ListEmploymentCustomFieldsResponseSchema
...
from remote_python_sdk.type.list_employment_custom_fields_response import ListEmploymentCustomFieldsResponse
...
from remote_python_sdk.pydantic.list_employment_custom_fields_response import ListEmploymentCustomFieldsResponse as ListEmploymentCustomFieldsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListEmploymentCustomFieldsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListEmploymentCustomFieldsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_definitions_mapped_args(
        self,
    ...
    async def _alist_definitions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/custom-fields',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListDefinitionsRaw(BaseApi):
    ...
    async def alist_definitions(
        ...
        **kwargs,
        ...
        args = self._list_definitions_mapped_args(
            page=page,
            page_size=page_size,
        )
        return await self._alist_definitions_oapg(
    ...
    def list_definitions(
        ...
        return self._list_definitions_oapg(
            query_params=args.query,
        )

class ListDefinitions(BaseApi):
    ...
    async def alist_definitions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListEmploymentCustomFieldsResponsePydantic:
        raw_response = await self.raw.alist_definitions(
            page=page,
            page_size=page_size,
            **kwargs,
        )
        if validate:
            return ListEmploymentCustomFieldsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListEmploymentCustomFieldsResponsePydantic, raw_response.body)
    ...
    def list_definitions(
        ...
        raw_response = self.raw.list_definitions(
            page=page,
            page_size=page_size,
        )
        if validate:
