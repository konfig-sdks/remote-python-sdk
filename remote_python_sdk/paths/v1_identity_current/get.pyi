...
from remote_python_sdk.model.identity_current_response import IdentityCurrentResponse as IdentityCurrentResponseSchema
...
from remote_python_sdk.type.identity_current_response import IdentityCurrentResponse
...
from remote_python_sdk.pydantic.identity_current_response import IdentityCurrentResponse as IdentityCurrentResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = IdentityCurrentResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: IdentityCurrentResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_token_info_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_token_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/identity/current',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetTokenInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_token_info(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor201Async,
        ...
        args = self._get_token_info_mapped_args(
        )
        return await self._aget_token_info_oapg(
            **kwargs,
        )
    ...
    def get_token_info(
        ...
        return self._get_token_info_oapg(
        )

class GetTokenInfo(BaseApi):

    async def aget_token_info(
        self,
        validate: bool = False,
        **kwargs,
    ) -> IdentityCurrentResponsePydantic:
        raw_response = await self.raw.aget_token_info(
            **kwargs,
        )
        if validate:
            return RootModel[IdentityCurrentResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(IdentityCurrentResponsePydantic, raw_response.body)
    ...
    def get_token_info(
        ...
        raw_response = self.raw.get_token_info(
        )
        if validate:
            return RootModel[IdentityCurrentResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(IdentityCurrentResponsePydantic, raw_response.body)
