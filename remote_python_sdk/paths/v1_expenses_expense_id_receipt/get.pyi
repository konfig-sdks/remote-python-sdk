...
class BaseApi(api_client.Api):
    ...
    def _download_receipt_mapped_args(
        self,
        expense_id: str,
    ...
    async def _adownload_receipt_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/expenses/{expense_id}/receipt',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DownloadReceiptRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="expenses")
    async def adownload_receipt(
        self,
        expense_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._download_receipt_mapped_args(
            expense_id=expense_id,
        )
        return await self._adownload_receipt_oapg(
    ...
    def download_receipt(
        ...
        return self._download_receipt_oapg(
            path_params=args.path,
        )

class DownloadReceipt(BaseApi):
    ...
    async def adownload_receipt(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_receipt(
            expense_id=expense_id,
            **kwargs,
        )
        if validate:
    ...
    def download_receipt(
        ...
        raw_response = self.raw.download_receipt(
            expense_id=expense_id,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
