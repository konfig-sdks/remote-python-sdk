...
SchemaFor200ResponseBodyApplicationJson = OffboardingResponseSchema
    ...
    async def _ashow_request_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/offboardings/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_request(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_request_mapped_args(
            id=id,
        )
        return await self._ashow_request_oapg(
    ...
    def show_request(
        ...
        return self._show_request_oapg(
            path_params=args.path,
        )

class ShowRequest(BaseApi):
    ...
    async def ashow_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashow_request(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def show_request(
        ...
        raw_response = self.raw.show_request(
            id=id,
        )
        if validate:
            return OffboardingResponsePydantic(**raw_response.body)
