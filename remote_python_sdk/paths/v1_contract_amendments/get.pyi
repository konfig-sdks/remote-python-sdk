...
from remote_python_sdk.model.list_contract_amendment_response import ListContractAmendmentResponse as ListContractAmendmentResponseSchema
...
from remote_python_sdk.type.list_contract_amendment_response import ListContractAmendmentResponse
...
from remote_python_sdk.pydantic.list_contract_amendment_response import ListContractAmendmentResponse as ListContractAmendmentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListContractAmendmentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListContractAmendmentResponse
...
class ListRequests(BaseApi):
    ...
    async def alist_requests(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListContractAmendmentResponsePydantic:
        raw_response = await self.raw.alist_requests(
            **kwargs,
        )
        if validate:
            return ListContractAmendmentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListContractAmendmentResponsePydantic, raw_response.body)
