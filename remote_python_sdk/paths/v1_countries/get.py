...
from remote_python_sdk.model.countries_response import CountriesResponse as CountriesResponseSchema
...
from remote_python_sdk.type.countries_response import CountriesResponse
...
from remote_python_sdk.pydantic.countries_response import CountriesResponse as CountriesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CountriesResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_alphabetically_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_alphabetically_oapg(
        self,
...
class ListAlphabeticallyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_alphabetically(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_alphabetically_mapped_args(
        )
        return await self._alist_alphabetically_oapg(
            **kwargs,
        )
    
    def list_alphabetically(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._list_alphabetically_oapg(
        )

class ListAlphabetically(BaseApi):

    async def alist_alphabetically(
        self,
        validate: bool = False,
        **kwargs,
    ) -> CountriesResponsePydantic:
        raw_response = await self.raw.alist_alphabetically(
            **kwargs,
        )
        if validate:
            return CountriesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CountriesResponsePydantic, raw_response.body)
    ...
    def list_alphabetically(
        ...
        raw_response = self.raw.list_alphabetically(
        )
        if validate:
            return CountriesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CountriesResponsePydantic, raw_response.body)
