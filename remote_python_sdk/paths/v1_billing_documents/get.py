...
from remote_python_sdk.model.billing_documents_response import BillingDocumentsResponse as BillingDocumentsResponseSchema
...
from remote_python_sdk.type.billing_documents_response import BillingDocumentsResponse
...
from remote_python_sdk.pydantic.billing_documents_response import BillingDocumentsResponse as BillingDocumentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BillingDocumentsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BillingDocumentsResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingDocumentsResponsePydantic:
        ...
        if validate:
            return BillingDocumentsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BillingDocumentsResponsePydantic, raw_response.body)
