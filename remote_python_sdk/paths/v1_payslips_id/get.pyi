...
from remote_python_sdk.model.payslip_response import PayslipResponse as PayslipResponseSchema
...
from remote_python_sdk.type.payslip_response import PayslipResponse
...
from remote_python_sdk.pydantic.payslip_response import PayslipResponse as PayslipResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PayslipResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayslipResponse
...
class ShowPayslipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_payslip(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_payslip_mapped_args(
            id=id,
        )
        return await self._ashow_payslip_oapg(
    ...
    def show_payslip(
        ...
        return self._show_payslip_oapg(
            path_params=args.path,
        )

class ShowPayslip(BaseApi):
    ...
    async def ashow_payslip(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayslipResponsePydantic:
        raw_response = await self.raw.ashow_payslip(
            id=id,
            **kwargs,
        )
        if validate:
            return PayslipResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayslipResponsePydantic, raw_response.body)
    ...
    def show_payslip(
        ...
        raw_response = self.raw.show_payslip(
            id=id,
        )
        if validate:
            return PayslipResponsePydantic(**raw_response.body)
