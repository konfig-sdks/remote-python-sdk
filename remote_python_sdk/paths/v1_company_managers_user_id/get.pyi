...
from remote_python_sdk.model.company_manager_response import CompanyManagerResponse as CompanyManagerResponseSchema
...
from remote_python_sdk.type.company_manager_response import CompanyManagerResponse
...
from remote_python_sdk.pydantic.company_manager_response import CompanyManagerResponse as CompanyManagerResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CompanyManagerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompanyManagerResponse
    ...
    async def _ashow_user_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/company-managers/{user_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_user(
        self,
        user_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_user_mapped_args(
            user_id=user_id,
        )
        return await self._ashow_user_oapg(
    ...
    def show_user(
        ...
        return self._show_user_oapg(
            path_params=args.path,
        )

class ShowUser(BaseApi):
    ...
    async def ashow_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompanyManagerResponsePydantic:
        raw_response = await self.raw.ashow_user(
            user_id=user_id,
            **kwargs,
        )
        if validate:
            return CompanyManagerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyManagerResponsePydantic, raw_response.body)
    ...
    def show_user(
        ...
        raw_response = self.raw.show_user(
            user_id=user_id,
        )
        if validate:
            return CompanyManagerResponsePydantic(**raw_response.body)
