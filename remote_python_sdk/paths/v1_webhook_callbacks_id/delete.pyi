...
class BaseApi(api_client.Api):
    ...
    def _delete_callback_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_callback_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/webhook-callbacks/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteCallbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_callback(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_callback_mapped_args(
            id=id,
        )
        return await self._adelete_callback_oapg(
    ...
    def delete_callback(
        ...
        return self._delete_callback_oapg(
            path_params=args.path,
        )

class DeleteCallback(BaseApi):
    ...
    async def adelete_callback(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_callback(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_callback(
        ...
        raw_response = self.raw.delete_callback(
            id=id,
        )
        if validate:
            return SuccessResponsePydantic(**raw_response.body)
