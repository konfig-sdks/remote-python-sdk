...
from remote_python_sdk.model.create_approved_timeoff_params import CreateApprovedTimeoffParams as CreateApprovedTimeoffParamsSchema
...
from remote_python_sdk.type.create_approved_timeoff_params import CreateApprovedTimeoffParams
...
from remote_python_sdk.pydantic.create_approved_timeoff_params import CreateApprovedTimeoffParams as CreateApprovedTimeoffParamsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateApprovedTimeoffParamsSchema


request_body_create_approved_timeoff_params = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TimeoffResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _record_create_mapped_args(
        self,
    ...
    async def _arecord_create_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_approved_timeoff_params.serialize(body, content_type)
...
class RecordCreateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arecord_create(
        self,
        approved_at: datetime,
        approver_id: NullableApproverId,
        status: str,
        ...
        **kwargs,
        ...
        args = self._record_create_mapped_args(
        ...
        return await self._arecord_create_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def record_create(
        ...
        return self._record_create_oapg(
            body=args.body,
        )

class RecordCreate(BaseApi):
    ...
    async def arecord_create(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arecord_create(
            approved_at=approved_at,
            approver_id=approver_id,
            status=status,
            document=document,
    ...
    def record_create(
        ...
        raw_response = self.raw.record_create(
            approved_at=approved_at,
            approver_id=approver_id,
            status=status,
            document=document,
