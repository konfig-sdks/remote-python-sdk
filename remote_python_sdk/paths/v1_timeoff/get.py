...
from remote_python_sdk.model.list_timeoff_response import ListTimeoffResponse as ListTimeoffResponseSchema
from remote_python_sdk.model.not_found_response import NotFoundResponse as NotFoundResponseSchema
from remote_python_sdk.model.timeoff_status import TimeoffStatus as TimeoffStatusSchema
...
from remote_python_sdk.type.timeoff_status import TimeoffStatus
from remote_python_sdk.type.too_many_requests_response import TooManyRequestsResponse
from remote_python_sdk.type.list_timeoff_response import ListTimeoffResponse
...
from remote_python_sdk.pydantic.list_timeoff_response import ListTimeoffResponse as ListTimeoffResponsePydantic
...
from remote_python_sdk.pydantic.timeoff_status import TimeoffStatus as TimeoffStatusPydantic
...
TimeoffTypeSchema = TimeoffTypeSchema
StatusSchema = TimeoffStatusSchema
...
class SortBySchema(
    ...
    @schemas.classproperty
    def TIMEOFF_TYPE(cls):
        return cls("timeoff_type")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'timeoff_type': typing.Union[TimeoffTypeSchema, ],
...
request_query_timeoff_type = api_client.QueryParameter(
    name="timeoff_type",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ListTimeoffResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListTimeoffResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_records_mapped_args(
        ...
        if timeoff_type is not None:
            _query_params["timeoff_type"] = timeoff_type
...
class ListRecordsRaw(BaseApi):
    ...
    async def alist_records(
        ...
        **kwargs,
        ...
        args = self._list_records_mapped_args(
        ...
        return await self._alist_records_oapg(
...
class ListRecords(BaseApi):
    ...
    async def alist_records(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListTimeoffResponsePydantic:
        raw_response = await self.raw.alist_records(
            employment_id=employment_id,
            timeoff_type=timeoff_type,
            status=status,
            order=order,
        ...
        if validate:
            return ListTimeoffResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListTimeoffResponsePydantic, raw_response.body)
    ...
    def list_records(
        ...
        raw_response = self.raw.list_records(
            employment_id=employment_id,
            timeoff_type=timeoff_type,
            status=status,
            order=order,
