...
from remote_python_sdk.model.list_expense_response import ListExpenseResponse as ListExpenseResponseSchema
...
from remote_python_sdk.type.list_expense_response import ListExpenseResponse
...
from remote_python_sdk.pydantic.list_expense_response import ListExpenseResponse as ListExpenseResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ListExpenseResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ListExpenseResponse
...
class ListRecords(BaseApi):
    ...
    async def alist_records(
        ...
        **kwargs,
        ...
        if validate:
            return ListExpenseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListExpenseResponsePydantic, raw_response.body)
