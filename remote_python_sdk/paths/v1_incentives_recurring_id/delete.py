...
from remote_python_sdk.model.delete_recurring_incentive_response import DeleteRecurringIncentiveResponse as DeleteRecurringIncentiveResponseSchema
...
from remote_python_sdk.type.delete_recurring_incentive_response import DeleteRecurringIncentiveResponse
...
from remote_python_sdk.pydantic.delete_recurring_incentive_response import DeleteRecurringIncentiveResponse as DeleteRecurringIncentiveResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeleteRecurringIncentiveResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteRecurringIncentiveResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_scheduled_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_scheduled_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/incentives/recurring/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteScheduledRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_scheduled(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_scheduled_mapped_args(
            id=id,
        )
        return await self._adelete_scheduled_oapg(
    ...
    def delete_scheduled(
        ...
        return self._delete_scheduled_oapg(
            path_params=args.path,
        )

class DeleteScheduled(BaseApi):
    ...
    async def adelete_scheduled(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteRecurringIncentiveResponsePydantic:
        raw_response = await self.raw.adelete_scheduled(
            id=id,
            **kwargs,
        )
        if validate:
            return DeleteRecurringIncentiveResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteRecurringIncentiveResponsePydantic, raw_response.body)
    ...
    def delete_scheduled(
        ...
        raw_response = self.raw.delete_scheduled(
            id=id,
        )
        if validate:
            return DeleteRecurringIncentiveResponsePydantic(**raw_response.body)
