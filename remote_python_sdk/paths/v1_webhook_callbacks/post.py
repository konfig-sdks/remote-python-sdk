...
from remote_python_sdk.model.create_webhook_callback_params import CreateWebhookCallbackParams as CreateWebhookCallbackParamsSchema
from remote_python_sdk.model.too_many_requests_response import TooManyRequestsResponse as TooManyRequestsResponseSchema
from remote_python_sdk.model.webhook_callback_response import WebhookCallbackResponse as WebhookCallbackResponseSchema
from remote_python_sdk.model.bad_request_response import BadRequestResponse as BadRequestResponseSchema
from remote_python_sdk.model.create_webhook_callback_params_subscribed_events import CreateWebhookCallbackParamsSubscribedEvents as CreateWebhookCallbackParamsSubscribedEventsSchema
from remote_python_sdk.model.unauthorized_response import UnauthorizedResponse as UnauthorizedResponseSchema

from remote_python_sdk.type.create_webhook_callback_params import CreateWebhookCallbackParams
...
from remote_python_sdk.type.webhook_callback_response import WebhookCallbackResponse
from remote_python_sdk.type.bad_request_response import BadRequestResponse
from remote_python_sdk.type.create_webhook_callback_params_subscribed_events import CreateWebhookCallbackParamsSubscribedEvents
...
from remote_python_sdk.pydantic.create_webhook_callback_params import CreateWebhookCallbackParams as CreateWebhookCallbackParamsPydantic
from remote_python_sdk.pydantic.not_found_response import NotFoundResponse as NotFoundResponsePydantic
from remote_python_sdk.pydantic.webhook_callback_response import WebhookCallbackResponse as WebhookCallbackResponsePydantic
from remote_python_sdk.pydantic.create_webhook_callback_params_subscribed_events import CreateWebhookCallbackParamsSubscribedEvents as CreateWebhookCallbackParamsSubscribedEventsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateWebhookCallbackParamsSchema


request_body_create_webhook_callback_params = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebhookCallbackResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: WebhookCallbackResponse
...
class BaseApi(api_client.Api):
    ...
    def _register_callback_mapped_args(
        self,
        url: str,
        subscribed_events: typing.Optional[CreateWebhookCallbackParamsSubscribedEvents] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if subscribed_events is not None:
            _body["subscribed_events"] = subscribed_events
        if url is not None:
            _body["url"] = url
        args.body = _body
        return args

    async def _aregister_callback_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/webhook-callbacks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_webhook_callback_params.serialize(body, content_type)
...
class RegisterCallbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aregister_callback(
        self,
        url: str,
        subscribed_events: typing.Optional[CreateWebhookCallbackParamsSubscribedEvents] = None,
        **kwargs,
        ...
        args = self._register_callback_mapped_args(
            url=url,
            subscribed_events=subscribed_events,
        )
        return await self._aregister_callback_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def register_callback(
        ...
        return self._register_callback_oapg(
            body=args.body,
        )

class RegisterCallback(BaseApi):
    ...
    async def aregister_callback(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhookCallbackResponsePydantic:
        raw_response = await self.raw.aregister_callback(
            url=url,
            subscribed_events=subscribed_events,
            **kwargs,
        )
        if validate:
            return WebhookCallbackResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhookCallbackResponsePydantic, raw_response.body)
    ...
    def register_callback(
        ...
        raw_response = self.raw.register_callback(
            url=url,
            subscribed_events=subscribed_events,
        )
        if validate:
