...
class BaseApi(api_client.Api):
    ...
    def _update_record_0_mapped_args(
        self,
        cancel_reason: str,
        edit_reason: str,
        id: str,
    ...
    async def _aupdate_record_0_oapg(
        self,
...
class UpdateRecord0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_record_0(
        self,
        cancel_reason: str,
        edit_reason: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._update_record_0_mapped_args(
        ...
        return await self._aupdate_record_0_oapg(
            body=args.body,
    ...
    def update_record_0(
        ...
        return self._update_record_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRecord0(BaseApi):
    ...
    async def aupdate_record_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_record_0(
            cancel_reason=cancel_reason,
            edit_reason=edit_reason,
            id=id,
            approved_at=approved_at,
    ...
    def update_record_0(
        ...
        raw_response = self.raw.update_record_0(
            cancel_reason=cancel_reason,
            edit_reason=edit_reason,
            id=id,
            approved_at=approved_at,
