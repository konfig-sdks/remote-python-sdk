...
from remote_python_sdk.model.cost_calculator_estimate_response import CostCalculatorEstimateResponse as CostCalculatorEstimateResponseSchema
...
from remote_python_sdk.type.cost_calculator_estimate_response import CostCalculatorEstimateResponse
...
from remote_python_sdk.pydantic.cost_calculator_estimate_response import CostCalculatorEstimateResponse as CostCalculatorEstimateResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CostCalculatorEstimateResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CostCalculatorEstimateResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_employment_estimation_mapped_args(
        self,
    ...
    async def _acreate_employment_estimation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/cost-calculator/estimation',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_employment_estimation_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateEmploymentEstimationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_employment_estimation(
        self,
        employer_currency_slug: str,
        employments: typing.List[CostCalculatorEmploymentParam],
        include_benefits: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_employment_estimation_mapped_args(
        ...
        return await self._acreate_employment_estimation_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_employment_estimation(
        self,
        employer_currency_slug: str,
        employments: typing.List[CostCalculatorEmploymentParam],
        include_benefits: typing.Optional[bool] = None,
        ...
        return self._create_employment_estimation_oapg(
            body=args.body,
        )

class CreateEmploymentEstimation(BaseApi):
    ...
    async def acreate_employment_estimation(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CostCalculatorEstimateResponsePydantic:
        raw_response = await self.raw.acreate_employment_estimation(
            employer_currency_slug=employer_currency_slug,
            employments=employments,
            include_benefits=include_benefits,
            include_cost_breakdowns=include_cost_breakdowns,
        ...
        if validate:
            return CostCalculatorEstimateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CostCalculatorEstimateResponsePydantic, raw_response.body)
    ...
    def create_employment_estimation(
        ...
        raw_response = self.raw.create_employment_estimation(
            employer_currency_slug=employer_currency_slug,
            employments=employments,
            include_benefits=include_benefits,
            include_cost_breakdowns=include_cost_breakdowns,
