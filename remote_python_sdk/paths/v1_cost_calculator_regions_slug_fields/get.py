...
from remote_python_sdk.model.json_schema_response import JSONSchemaResponse as JSONSchemaResponseSchema
...
from remote_python_sdk.type.json_schema_response import JSONSchemaResponse
...
from remote_python_sdk.pydantic.json_schema_response import JSONSchemaResponse as JSONSchemaResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JSONSchemaResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _show_region_fields_mapped_args(
        self,
        slug: str,
    ...
    async def _ashow_region_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/cost-calculator/regions/{slug}/fields',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowRegionFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_region_fields(
        self,
        slug: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_region_fields_mapped_args(
            slug=slug,
        )
        return await self._ashow_region_fields_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def show_region_fields(
        self,
        slug: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._show_region_fields_oapg(
            path_params=args.path,
        )

class ShowRegionFields(BaseApi):
    ...
    async def ashow_region_fields(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JSONSchemaResponsePydantic:
        raw_response = await self.raw.ashow_region_fields(
            slug=slug,
            **kwargs,
        )
        if validate:
            return JSONSchemaResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JSONSchemaResponsePydantic, raw_response.body)
    ...
    def show_region_fields(
        ...
        raw_response = self.raw.show_region_fields(
            slug=slug,
        )
        if validate:
            return JSONSchemaResponsePydantic(**raw_response.body)
