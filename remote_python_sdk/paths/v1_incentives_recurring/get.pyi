...
from remote_python_sdk.model.list_recurring_incentives_response import ListRecurringIncentivesResponse as ListRecurringIncentivesResponseSchema
...
from remote_python_sdk.type.list_recurring_incentives_response import ListRecurringIncentivesResponse
...
from remote_python_sdk.pydantic.list_recurring_incentives_response import ListRecurringIncentivesResponse as ListRecurringIncentivesResponsePydantic

# Query params
StatusSchema = schemas.StrSchema
TypeSchema = schemas.StrSchema
NoteSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'note': typing.Union[NoteSchema, str, ],
...
request_query_note = api_client.QueryParameter(
    name="note",
    style=api_client.ParameterStyle.FORM,
    schema=NoteSchema,
    explode=True,
...
SchemaFor201ResponseBodyApplicationJson = ListRecurringIncentivesResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ListRecurringIncentivesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_incentives_mapped_args(
        self,
    ...
    async def _alist_incentives_oapg(
        self,
...
class ListIncentivesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_incentives(
        self,
        status: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        note: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_incentives_mapped_args(
            status=status,
            type=type,
            note=note,
            page=page,
        ...
        return await self._alist_incentives_oapg(
    ...
    def list_incentives(
        ...
        return self._list_incentives_oapg(
            query_params=args.query,
        )

class ListIncentives(BaseApi):
    ...
    async def alist_incentives(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListRecurringIncentivesResponsePydantic:
        raw_response = await self.raw.alist_incentives(
            status=status,
            type=type,
            note=note,
            page=page,
        ...
        if validate:
            return ListRecurringIncentivesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListRecurringIncentivesResponsePydantic, raw_response.body)
    ...
    def list_incentives(
        ...
        raw_response = self.raw.list_incentives(
            status=status,
            type=type,
            note=note,
            page=page,
