...
from remote_python_sdk.model.create_recurring_incentive_params import CreateRecurringIncentiveParams as CreateRecurringIncentiveParamsSchema
...
from remote_python_sdk.model.recurring_incentive_response import RecurringIncentiveResponse as RecurringIncentiveResponseSchema
...
from remote_python_sdk.type.create_recurring_incentive_params import CreateRecurringIncentiveParams
from remote_python_sdk.type.unprocessable_entity_response import UnprocessableEntityResponse
from remote_python_sdk.type.recurring_incentive_response import RecurringIncentiveResponse
...
from remote_python_sdk.pydantic.recurring_incentive_response import RecurringIncentiveResponse as RecurringIncentiveResponsePydantic
...
from remote_python_sdk.pydantic.create_recurring_incentive_params import CreateRecurringIncentiveParams as CreateRecurringIncentiveParamsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateRecurringIncentiveParamsSchema


request_body_create_recurring_incentive_params = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RecurringIncentiveResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: RecurringIncentiveResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_monthly_incentive_mapped_args(
        self,
        amount: int,
        ...
        if duration_in_months is not None:
            _body["duration_in_months"] = duration_in_months
    ...
    async def _acreate_monthly_incentive_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/incentives/recurring',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_recurring_incentive_params.serialize(body, content_type)
    ...
    def _create_monthly_incentive_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateMonthlyIncentiveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_monthly_incentive(
        self,
        amount: int,
        amount_tax_type: AmountTaxType,
        effective_date: date,
        ...
        **kwargs,
        ...
        args = self._create_monthly_incentive_mapped_args(
            amount=amount,
        ...
        return await self._acreate_monthly_incentive_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_monthly_incentive(
        self,
        amount: int,
        amount_tax_type: AmountTaxType,
        effective_date: date,
        ...
        return self._create_monthly_incentive_oapg(
            body=args.body,
        )

class CreateMonthlyIncentive(BaseApi):
    ...
    async def acreate_monthly_incentive(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RecurringIncentiveResponsePydantic:
        raw_response = await self.raw.acreate_monthly_incentive(
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
            employment_id=employment_id,
        ...
        if validate:
            return RecurringIncentiveResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RecurringIncentiveResponsePydantic, raw_response.body)
    ...
    def create_monthly_incentive(
        ...
        raw_response = self.raw.create_monthly_incentive(
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
            employment_id=employment_id,
