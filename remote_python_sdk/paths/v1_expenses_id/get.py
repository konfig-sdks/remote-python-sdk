...
class ShowRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_record(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_record_mapped_args(
            id=id,
        )
        return await self._ashow_record_oapg(
    ...
    def show_record(
        ...
        return self._show_record_oapg(
            path_params=args.path,
        )

class ShowRecord(BaseApi):
    ...
    async def ashow_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashow_record(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def show_record(
        ...
        raw_response = self.raw.show_record(
            id=id,
        )
        if validate:
            return ExpenseResponsePydantic(**raw_response.body)
