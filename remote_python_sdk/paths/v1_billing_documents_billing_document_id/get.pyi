...
from remote_python_sdk.model.billing_document_response import BillingDocumentResponse as BillingDocumentResponseSchema
...
from remote_python_sdk.type.billing_document_response import BillingDocumentResponse
...
from remote_python_sdk.pydantic.billing_document_response import BillingDocumentResponse as BillingDocumentResponsePydantic
...
# Path params
BillingDocumentIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'billing_document_id': typing.Union[BillingDocumentIdSchema, str, ],
    }
)
...
request_path_billing_document_id = api_client.PathParameter(
    name="billing_document_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BillingDocumentIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = BillingDocumentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BillingDocumentResponse
...
class BaseApi(api_client.Api):
    ...
    def _show_details_mapped_args(
        ...
        _path_params = {}
        if billing_document_id is not None:
            _path_params["billing_document_id"] = billing_document_id
    ...
    async def _ashow_details_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_billing_document_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/billing-documents/{billing_document_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowDetails(BaseApi):
    ...
    async def ashow_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingDocumentResponsePydantic:
        raw_response = await self.raw.ashow_details(
            billing_document_id=billing_document_id,
            **kwargs,
        )
        if validate:
            return BillingDocumentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BillingDocumentResponsePydantic, raw_response.body)
