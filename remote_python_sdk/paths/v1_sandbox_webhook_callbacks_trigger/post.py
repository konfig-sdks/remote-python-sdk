...
from remote_python_sdk.model.webhook_trigger_params import WebhookTriggerParams as WebhookTriggerParamsSchema
...
from remote_python_sdk.type.webhook_trigger_params import WebhookTriggerParams
...
from remote_python_sdk.pydantic.webhook_trigger_params import WebhookTriggerParams as WebhookTriggerParamsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = WebhookTriggerParamsSchema


request_body_webhook_trigger_params = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SuccessResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _trigger_webhook_callback_mapped_args(
        self,
    ...
    async def _atrigger_webhook_callback_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/sandbox/webhook-callbacks/trigger',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_webhook_trigger_params.serialize(body, content_type)
    ...
    def _trigger_webhook_callback_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class TriggerWebhookCallbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atrigger_webhook_callback(
        self,
        employment_id: typing.Optional[str] = None,
        event_type: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._trigger_webhook_callback_mapped_args(
            employment_id=employment_id,
            event_type=event_type,
        )
        return await self._atrigger_webhook_callback_oapg(
            body=args.body,
            **kwargs,
        )
    
    def trigger_webhook_callback(
        self,
        employment_id: typing.Optional[str] = None,
        event_type: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._trigger_webhook_callback_oapg(
            body=args.body,
        )

class TriggerWebhookCallback(BaseApi):
    ...
    async def atrigger_webhook_callback(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atrigger_webhook_callback(
            employment_id=employment_id,
            event_type=event_type,
            **kwargs,
        )
    ...
    def trigger_webhook_callback(
        ...
        raw_response = self.raw.trigger_webhook_callback(
            employment_id=employment_id,
            event_type=event_type,
        )
        if validate:
