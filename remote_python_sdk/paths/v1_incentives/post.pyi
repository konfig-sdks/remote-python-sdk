...
from remote_python_sdk.model.create_one_time_incentive_params import CreateOneTimeIncentiveParams as CreateOneTimeIncentiveParamsSchema
...
from remote_python_sdk.type.create_one_time_incentive_params import CreateOneTimeIncentiveParams
...
from remote_python_sdk.pydantic.create_one_time_incentive_params import CreateOneTimeIncentiveParams as CreateOneTimeIncentiveParamsPydantic
from remote_python_sdk.pydantic.bad_request_response import BadRequestResponse as BadRequestResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = CreateOneTimeIncentiveParamsSchema


request_body_create_one_time_incentive_params = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = IncentiveResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_incentive_mapped_args(
        self,
        amount: int,
    ...
    async def _acreate_incentive_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_one_time_incentive_params.serialize(body, content_type)
...
class CreateIncentiveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_incentive(
        self,
        amount: int,
        amount_tax_type: AmountTaxType,
        effective_date: date,
        ...
        **kwargs,
        ...
        args = self._create_incentive_mapped_args(
            amount=amount,
        ...
        return await self._acreate_incentive_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_incentive(
        ...
        return self._create_incentive_oapg(
            body=args.body,
        )

class CreateIncentive(BaseApi):
    ...
    async def acreate_incentive(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_incentive(
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
            employment_id=employment_id,
    ...
    def create_incentive(
        ...
        raw_response = self.raw.create_incentive(
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
            employment_id=employment_id,
