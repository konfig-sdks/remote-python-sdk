...
from remote_python_sdk.model.list_incentives_response import ListIncentivesResponse as ListIncentivesResponseSchema
...
from remote_python_sdk.type.list_incentives_response import ListIncentivesResponse
...
from remote_python_sdk.pydantic.list_incentives_response import ListIncentivesResponse as ListIncentivesResponsePydantic
...
RecurringIncentiveIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'recurring_incentive_id': typing.Union[RecurringIncentiveIdSchema, str, ],
...
request_query_recurring_incentive_id = api_client.QueryParameter(
    name="recurring_incentive_id",
    style=api_client.ParameterStyle.FORM,
    schema=RecurringIncentiveIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ListIncentivesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListIncentivesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_mapped_args(
        ...
        recurring_incentive_id: typing.Optional[str] = None,
        ...
        if recurring_incentive_id is not None:
            _query_params["recurring_incentive_id"] = recurring_incentive_id
        if page is not None:
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_recurring_incentive_id,
            request_query_page,
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListIncentivesResponsePydantic:
        ...
        if validate:
            return ListIncentivesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListIncentivesResponsePydantic, raw_response.body)
