...
from remote_python_sdk.model.holidays_response import HolidaysResponse as HolidaysResponseSchema
...
from remote_python_sdk.type.holidays_response import HolidaysResponse
...
from remote_python_sdk.pydantic.holidays_response import HolidaysResponse as HolidaysResponsePydantic

# Query params
CountrySubdivisionCodeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'country_subdivision_code': typing.Union[CountrySubdivisionCodeSchema, str, ],
    },
    total=False
)
...
request_query_country_subdivision_code = api_client.QueryParameter(
    name="country_subdivision_code",
    style=api_client.ParameterStyle.FORM,
    schema=CountrySubdivisionCodeSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = HolidaysResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: HolidaysResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_holidays_by_year_mapped_args(
        self,
        country_code: str,
        year: str,
        ...
        if country_subdivision_code is not None:
            _query_params["country_subdivision_code"] = country_subdivision_code
    ...
    async def _alist_holidays_by_year_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_country_subdivision_code,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/countries/{country_code}/holidays/{year}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_holidays_by_year_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListHolidaysByYearRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_holidays_by_year(
        self,
        country_code: str,
        year: str,
        country_subdivision_code: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_holidays_by_year_mapped_args(
            country_code=country_code,
            year=year,
            country_subdivision_code=country_subdivision_code,
        )
        return await self._alist_holidays_by_year_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_holidays_by_year(
        self,
        country_code: str,
        year: str,
        country_subdivision_code: typing.Optional[str] = None,
        ...
        return self._list_holidays_by_year_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListHolidaysByYear(BaseApi):
    ...
    async def alist_holidays_by_year(
        ...
        validate: bool = False,
        **kwargs,
    ) -> HolidaysResponsePydantic:
        raw_response = await self.raw.alist_holidays_by_year(
            country_code=country_code,
            year=year,
            country_subdivision_code=country_subdivision_code,
            **kwargs,
        ...
        if validate:
            return HolidaysResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(HolidaysResponsePydantic, raw_response.body)
    ...
    def list_holidays_by_year(
        ...
        raw_response = self.raw.list_holidays_by_year(
            country_code=country_code,
            year=year,
            country_subdivision_code=country_subdivision_code,
        )
