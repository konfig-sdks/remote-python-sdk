...
from remote_python_sdk.model.contract_amendment_automatable_response import ContractAmendmentAutomatableResponse as ContractAmendmentAutomatableResponseSchema
...
from remote_python_sdk.model.create_contract_amendment_params import CreateContractAmendmentParams as CreateContractAmendmentParamsSchema
...
from remote_python_sdk.type.contract_amendment_automatable_response import ContractAmendmentAutomatableResponse
from remote_python_sdk.type.unprocessable_entity_response import UnprocessableEntityResponse
from remote_python_sdk.type.create_contract_amendment_params import CreateContractAmendmentParams
...
from remote_python_sdk.pydantic.contract_amendment_automatable_response import ContractAmendmentAutomatableResponse as ContractAmendmentAutomatableResponsePydantic
...
from remote_python_sdk.pydantic.create_contract_amendment_params import CreateContractAmendmentParams as CreateContractAmendmentParamsPydantic
from remote_python_sdk.pydantic.bad_request_response import BadRequestResponse as BadRequestResponsePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateContractAmendmentParamsSchema


request_body_create_contract_amendment_params = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContractAmendmentAutomatableResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContractAmendmentAutomatableResponse
...
class BaseApi(api_client.Api):
    ...
    def _check_automatability_mapped_args(
        self,
        amendment_contract_id: str,
        contract_amendment: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        employment_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if amendment_contract_id is not None:
            _body["amendment_contract_id"] = amendment_contract_id
        if contract_amendment is not None:
            _body["contract_amendment"] = contract_amendment
        if employment_id is not None:
            _body["employment_id"] = employment_id
        args.body = _body
        return args

    async def _acheck_automatability_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/contract-amendments/automatable',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_contract_amendment_params.serialize(body, content_type)
    ...
    def _check_automatability_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckAutomatabilityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_automatability(
        self,
        amendment_contract_id: str,
        contract_amendment: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        employment_id: str,
        **kwargs,
        ...
        args = self._check_automatability_mapped_args(
            amendment_contract_id=amendment_contract_id,
            contract_amendment=contract_amendment,
            employment_id=employment_id,
        )
        return await self._acheck_automatability_oapg(
            body=args.body,
            **kwargs,
        )
    
    def check_automatability(
        self,
        amendment_contract_id: str,
        contract_amendment: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        employment_id: str,
        ...
        return self._check_automatability_oapg(
            body=args.body,
        )

class CheckAutomatability(BaseApi):
    ...
    async def acheck_automatability(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContractAmendmentAutomatableResponsePydantic:
        raw_response = await self.raw.acheck_automatability(
            amendment_contract_id=amendment_contract_id,
            contract_amendment=contract_amendment,
            employment_id=employment_id,
            **kwargs,
        ...
        if validate:
            return ContractAmendmentAutomatableResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContractAmendmentAutomatableResponsePydantic, raw_response.body)
    ...
    def check_automatability(
        ...
        raw_response = self.raw.check_automatability(
            amendment_contract_id=amendment_contract_id,
            contract_amendment=contract_amendment,
            employment_id=employment_id,
        )
