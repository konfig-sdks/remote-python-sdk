...
from remote_python_sdk.model.company_managers_response import CompanyManagersResponse as CompanyManagersResponseSchema
...
from remote_python_sdk.type.company_managers_response import CompanyManagersResponse
...
from remote_python_sdk.pydantic.company_managers_response import CompanyManagersResponse as CompanyManagersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CompanyManagersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompanyManagersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_managers_mapped_args(
        self,
    ...
    async def _alist_managers_oapg(
        self,
...
class ListManagersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_managers(
        self,
        company_id: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        page_size: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_managers_mapped_args(
            company_id=company_id,
            page=page,
            page_size=page_size,
        )
        return await self._alist_managers_oapg(
    ...
    def list_managers(
        ...
        return self._list_managers_oapg(
            query_params=args.query,
        )

class ListManagers(BaseApi):
    ...
    async def alist_managers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompanyManagersResponsePydantic:
        raw_response = await self.raw.alist_managers(
            company_id=company_id,
            page=page,
            page_size=page_size,
            **kwargs,
        ...
        if validate:
            return CompanyManagersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyManagersResponsePydantic, raw_response.body)
    ...
    def list_managers(
        ...
        raw_response = self.raw.list_managers(
            company_id=company_id,
            page=page,
            page_size=page_size,
        )
