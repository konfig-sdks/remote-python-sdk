...
from remote_python_sdk.model.employment_custom_field_value_response import EmploymentCustomFieldValueResponse as EmploymentCustomFieldValueResponseSchema
...
from remote_python_sdk.type.employment_custom_field_value_response import EmploymentCustomFieldValueResponse
...
from remote_python_sdk.pydantic.employment_custom_field_value_response import EmploymentCustomFieldValueResponse as EmploymentCustomFieldValueResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'custom_field_id': typing.Union[CustomFieldIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = EmploymentCustomFieldValueResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmploymentCustomFieldValueResponse
    ...
    async def _ashow_value_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/custom-fields/{custom_field_id}/values/{employment_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowValueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_value(
        self,
        custom_field_id: str,
        employment_id: str,
        **kwargs,
        ...
        args = self._show_value_mapped_args(
            custom_field_id=custom_field_id,
            employment_id=employment_id,
        )
        return await self._ashow_value_oapg(
    ...
    def show_value(
        ...
        return self._show_value_oapg(
            path_params=args.path,
        )

class ShowValue(BaseApi):
    ...
    async def ashow_value(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmploymentCustomFieldValueResponsePydantic:
        raw_response = await self.raw.ashow_value(
            custom_field_id=custom_field_id,
            employment_id=employment_id,
            **kwargs,
        )
        if validate:
            return EmploymentCustomFieldValueResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmploymentCustomFieldValueResponsePydantic, raw_response.body)
    ...
    def show_value(
        ...
        raw_response = self.raw.show_value(
            custom_field_id=custom_field_id,
            employment_id=employment_id,
        )
        if validate:
