...
from remote_python_sdk.model.contract_amendment_response import ContractAmendmentResponse as ContractAmendmentResponseSchema
...
from remote_python_sdk.type.contract_amendment_response import ContractAmendmentResponse
...
from remote_python_sdk.pydantic.contract_amendment_response import ContractAmendmentResponse as ContractAmendmentResponsePydantic
...
# Path params
ContractAmendmentRequestIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'contract_amendment_request_id': typing.Union[ContractAmendmentRequestIdSchema, str, ],
    }
)
...
request_path_contract_amendment_request_id = api_client.PathParameter(
    name="contract_amendment_request_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ContractAmendmentRequestIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = ContractAmendmentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContractAmendmentResponse
...
class BaseApi(api_client.Api):
    ...
    def _approve_amendment_mapped_args(
        self,
        contract_amendment_request_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        if contract_amendment_request_id is not None:
            _path_params["contract_amendment_request_id"] = contract_amendment_request_id
        args.path = _path_params
        return args

    async def _aapprove_amendment_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_contract_amendment_request_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/sandbox/contract-amendments/{contract_amendment_request_id}/approve',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ApproveAmendmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aapprove_amendment(
        self,
        contract_amendment_request_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._approve_amendment_mapped_args(
            contract_amendment_request_id=contract_amendment_request_id,
        )
        return await self._aapprove_amendment_oapg(
    ...
    def approve_amendment(
        ...
        return self._approve_amendment_oapg(
            path_params=args.path,
        )

class ApproveAmendment(BaseApi):
    ...
    async def aapprove_amendment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContractAmendmentResponsePydantic:
        raw_response = await self.raw.aapprove_amendment(
            contract_amendment_request_id=contract_amendment_request_id,
            **kwargs,
        )
        if validate:
            return ContractAmendmentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContractAmendmentResponsePydantic, raw_response.body)
    ...
    def approve_amendment(
        ...
        raw_response = self.raw.approve_amendment(
            contract_amendment_request_id=contract_amendment_request_id,
        )
        if validate:
            return ContractAmendmentResponsePydantic(**raw_response.body)
