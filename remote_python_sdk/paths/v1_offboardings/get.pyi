...
from remote_python_sdk.model.list_offboarding_response import ListOffboardingResponse as ListOffboardingResponseSchema
...
from remote_python_sdk.type.list_offboarding_response import ListOffboardingResponse
...
from remote_python_sdk.pydantic.list_offboarding_response import ListOffboardingResponse as ListOffboardingResponsePydantic
...
IncludeConfidentialSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'include_confidential': typing.Union[IncludeConfidentialSchema, str, ],
...
request_query_include_confidential = api_client.QueryParameter(
    name="include_confidential",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeConfidentialSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ListOffboardingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListOffboardingResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_requests_mapped_args(
        ...
        include_confidential: typing.Optional[str] = None,
        ...
        if include_confidential is not None:
            _query_params["include_confidential"] = include_confidential
        if page is not None:
    ...
    async def _alist_requests_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_type,
            request_query_include_confidential,
            request_query_page,
...
class ListRequests(BaseApi):
    ...
    async def alist_requests(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListOffboardingResponsePydantic:
        ...
        if validate:
            return ListOffboardingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListOffboardingResponsePydantic, raw_response.body)
