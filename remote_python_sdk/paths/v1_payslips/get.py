...
from remote_python_sdk.model.list_payslips_response import ListPayslipsResponse as ListPayslipsResponseSchema
...
from remote_python_sdk.type.list_payslips_response import ListPayslipsResponse
from remote_python_sdk.type.unauthorized_response import UnauthorizedResponse

from ...api_client import Dictionary
from remote_python_sdk.pydantic.list_payslips_response import ListPayslipsResponse as ListPayslipsResponsePydantic
...
ExpectedPayoutStartDateSchema = schemas.StrSchema
ExpectedPayoutEndDateSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'expected_payout_start_date': typing.Union[ExpectedPayoutStartDateSchema, str, ],
        'expected_payout_end_date': typing.Union[ExpectedPayoutEndDateSchema, str, ],
...
request_query_expected_payout_start_date = api_client.QueryParameter(
    name="expected_payout_start_date",
    style=api_client.ParameterStyle.FORM,
    schema=ExpectedPayoutStartDateSchema,
    explode=True,
)
request_query_expected_payout_end_date = api_client.QueryParameter(
    name="expected_payout_end_date",
    style=api_client.ParameterStyle.FORM,
    schema=ExpectedPayoutEndDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ListPayslipsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListPayslipsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_mapped_args(
        ...
        expected_payout_start_date: typing.Optional[str] = None,
        expected_payout_end_date: typing.Optional[str] = None,
        ...
        if expected_payout_start_date is not None:
            _query_params["expected_payout_start_date"] = expected_payout_start_date
        if expected_payout_end_date is not None:
            _query_params["expected_payout_end_date"] = expected_payout_end_date
        if page is not None:
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_expected_payout_start_date,
            request_query_expected_payout_end_date,
            request_query_page,
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        args = self._list_all_mapped_args(
            ...
            end_date=end_date,
            expected_payout_start_date=expected_payout_start_date,
            expected_payout_end_date=expected_payout_end_date,
            page=page,
            page_size=page_size,
        )
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return ListPayslipsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListPayslipsResponsePydantic, raw_response.body)
