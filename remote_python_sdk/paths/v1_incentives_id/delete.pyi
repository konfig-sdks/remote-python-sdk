...
class BaseApi(api_client.Api):
    ...
    def _remove_incentive_mapped_args(
        self,
        id: str,
    ...
    async def _aremove_incentive_oapg(
        self,
...
class RemoveIncentiveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_incentive(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_incentive_mapped_args(
            id=id,
        )
        return await self._aremove_incentive_oapg(
    ...
    def remove_incentive(
        ...
        return self._remove_incentive_oapg(
            path_params=args.path,
        )

class RemoveIncentive(BaseApi):
    ...
    async def aremove_incentive(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_incentive(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def remove_incentive(
        ...
        raw_response = self.raw.remove_incentive(
            id=id,
        )
        if validate:
            return SuccessResponsePydantic(**raw_response.body)
