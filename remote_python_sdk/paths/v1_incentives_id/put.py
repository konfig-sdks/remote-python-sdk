...
class BaseApi(api_client.Api):
    ...
    def _update_incentive_mapped_args(
        self,
        id: str,
    ...
    async def _aupdate_incentive_oapg(
        self,
...
class UpdateIncentiveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_incentive(
        self,
        id: str,
        amount: typing.Optional[int] = None,
        amount_tax_type: typing.Optional[AmountTaxType] = None,
        ...
        **kwargs,
        ...
        args = self._update_incentive_mapped_args(
            id=id,
            amount=amount,
        ...
        return await self._aupdate_incentive_oapg(
            body=args.body,
    ...
    def update_incentive(
        ...
        return self._update_incentive_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateIncentive(BaseApi):
    ...
    async def aupdate_incentive(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_incentive(
            id=id,
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
    ...
    def update_incentive(
        ...
        raw_response = self.raw.update_incentive(
            id=id,
            amount=amount,
            amount_tax_type=amount_tax_type,
            effective_date=effective_date,
