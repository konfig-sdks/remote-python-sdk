...
from remote_python_sdk.model.timeoff_balance_response import TimeoffBalanceResponse as TimeoffBalanceResponseSchema
from remote_python_sdk.model.timeoff_balance_not_found_response import TimeoffBalanceNotFoundResponse as TimeoffBalanceNotFoundResponseSchema
...
from remote_python_sdk.type.timeoff_balance_not_found_response import TimeoffBalanceNotFoundResponse
from remote_python_sdk.type.timeoff_balance_response import TimeoffBalanceResponse
...
from remote_python_sdk.pydantic.timeoff_balance_response import TimeoffBalanceResponse as TimeoffBalanceResponsePydantic
...
from remote_python_sdk.pydantic.timeoff_balance_not_found_response import TimeoffBalanceNotFoundResponse as TimeoffBalanceNotFoundResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeoffBalanceResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeoffBalanceResponse
...
SchemaFor404ResponseBodyApplicationJson = TimeoffBalanceNotFoundResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: TimeoffBalanceNotFoundResponse
    ...
    async def _ashow_balance_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/timeoff-balances/{employment_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShowBalanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_balance(
        self,
        employment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._show_balance_mapped_args(
            employment_id=employment_id,
        )
        return await self._ashow_balance_oapg(
    ...
    def show_balance(
        ...
        return self._show_balance_oapg(
            path_params=args.path,
        )

class ShowBalance(BaseApi):
    ...
    async def ashow_balance(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeoffBalanceResponsePydantic:
        raw_response = await self.raw.ashow_balance(
            employment_id=employment_id,
            **kwargs,
        )
        if validate:
            return TimeoffBalanceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeoffBalanceResponsePydantic, raw_response.body)
    ...
    def show_balance(
        ...
        raw_response = self.raw.show_balance(
            employment_id=employment_id,
        )
        if validate:
            return TimeoffBalanceResponsePydantic(**raw_response.body)
