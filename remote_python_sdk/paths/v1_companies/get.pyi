...
from remote_python_sdk.model.companies_response import CompaniesResponse as CompaniesResponseSchema
...
from remote_python_sdk.type.companies_response import CompaniesResponse
...
from remote_python_sdk.pydantic.companies_response import CompaniesResponse as CompaniesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CompaniesResponseSchema
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompaniesResponsePydantic:
        raw_response = await self.raw.alist_all(
            **kwargs,
        )
        if validate:
            return CompaniesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompaniesResponsePydantic, raw_response.body)
