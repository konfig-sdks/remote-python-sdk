...
from remote_python_sdk.pydantic.recurring_incentive import RecurringIncentive

class ListRecurringIncentivesResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    recurring_incentives: typing.Optional[typing.List[RecurringIncentive]] = Field(None, alias='recurring_incentives')
