...
from remote_python_sdk.pydantic.minimal_employment import MinimalEmployment

class ListEmploymentsResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    employments: typing.Optional[typing.List[MinimalEmployment]] = Field(None, alias='employments')
