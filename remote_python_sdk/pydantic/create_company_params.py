...
class CreateCompanyParams(BaseModel):
    ...
    company_owner_name: str = Field(alias='company_owner_name')
    ...
    desired_currency: Literal["AUD", "CAD", "CHF", "DKK", "EUR", "GBP", "JPY", "NOK", "NZD", "SEK", "SGD", "USD"] = Field(alias='desired_currency')
    ...
    email_domain: typing.Optional[str] = Field(None, alias='email_domain')
