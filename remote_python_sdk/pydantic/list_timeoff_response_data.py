...
from remote_python_sdk.pydantic.timeoff import Timeoff

class ListTimeoffResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    timeoffs: typing.Optional[typing.List[Timeoff]] = Field(None, alias='timeoffs')
