...
from remote_python_sdk.pydantic.offboarding import Offboarding

class ListOffboardingResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    offboardings: typing.Optional[typing.List[Offboarding]] = Field(None, alias='offboardings')
