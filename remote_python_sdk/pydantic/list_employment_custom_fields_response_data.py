...
from remote_python_sdk.pydantic.employment_custom_field import EmploymentCustomField

class ListEmploymentCustomFieldsResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    custom_fields: typing.Optional[typing.List[EmploymentCustomField]] = Field(None, alias='custom_fields')
