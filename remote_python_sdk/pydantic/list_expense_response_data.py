...
from remote_python_sdk.pydantic.expense import Expense

class ListExpenseResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    expenses: typing.Optional[typing.List[Expense]] = Field(None, alias='expenses')
