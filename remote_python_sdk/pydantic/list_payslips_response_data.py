...
from remote_python_sdk.pydantic.payslip import Payslip

class ListPayslipsResponseData(BaseModel):
    # The current page among all of the total_pages
    current_page: typing.Optional[int] = Field(None, alias='current_page')

    payslips: typing.Optional[typing.List[Payslip]] = Field(None, alias='payslips')
