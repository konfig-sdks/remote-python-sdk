...
from remote_python_sdk.pydantic.company_manager import CompanyManager

class CompanyManagersResponseData(BaseModel):
    company_managers: typing.Optional[typing.List[CompanyManager]] = Field(None, alias='company_managers')
